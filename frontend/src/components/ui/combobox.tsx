...
import { InputGroup, InputGroupAddon, InputGroupButton, InputGroupInput, inputGroupButtonVariants } from "@/components/ui/input-group";
        ...
        {showTrigger && (
          <ComboboxPrimitive.Trigger
            ...
            className={cn(
              ...
              "ghost group-has-data-[slot=combobox-clear]/input-group:hidden data-pressed:bg-transparent",
            )}
          >
            <ChevronDownIcon className="text-muted-foreground size-4 pointer-events-none" />
          </ComboboxPrimitive.Trigger>
